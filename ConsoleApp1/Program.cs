...
namespace ConsoleApp1
{
     class Program
    {
        ...
        {
            Console.WriteLine("-----------------------------------------------------------------------------------------------------------");
            Console.WriteLine("------------------------------ Details Of Address Book Display All Fields And Continues-------------------------------");
            int i;
            for (i = 0; i < N; i++)
            {
        ...
        public static void SortContactPerson()
        {
            ...
            foreach (KeyValuePair<string, List<AddressBook>> kvp in NumberNames)
            {
              ...
              CompareToContact contactPersonComparer = new CompareToContact();
                switch (option)
                {
                    case 1:
                        //Set field based on the switch case Option
                        contactPersonComparer.compareThroughFields = CompareToContact.sortBy.firstName;
                        //Call Sort Method
                        listAddressBook.Sort(contactPersonComparer);
                        break;
                    case 2:
                        contactPersonComparer.compareThroughFields = CompareToContact.sortBy.state;
                        listAddressBook.Sort(contactPersonComparer);
                        break;
                    case 3:
                        contactPersonComparer.compareThroughFields = CompareToContact.sortBy.city;
                        listAddressBook.Sort(contactPersonComparer);
                        break;
                    case 4:
                        contactPersonComparer.compareThroughFields = CompareToContact.sortBy.zip;
                        listAddressBook.Sort(contactPersonComparer);
                        break;
                }
        ...
        public static void Search()
        {
            ...
            switch (option)
            {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    NewFileIo.GetDictionary(NumberNames);
                    break;
                case 6:
                   NewFileIo .ReadAddressBook();
                    break;
                case 7:
                    CsvServi.CSVServi(NumberNames);
                    break;
